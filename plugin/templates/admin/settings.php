	...
	<div class="fcs-admin fcs-wrap fcs-editor-shell">
		<div class="fcs-page-header fcs-editor-header">
			<h1 class="fcs-page-title">
				<?php
				esc_html_e( 'FuelChef Subscriptions', 'fuelchef-subscriptions' );
				?>
				&rsaquo; 
				<?php
				esc_html_e( 'Settings', 'fuelchef-subscriptions' );
				?>
			</h1>
		...
		<nav class="fcs-nav-tabs" aria-label="
		<?php
		esc_attr_e( 'Settings Tabs', 'fuelchef-subscriptions' );
		?>
		">
			<button type="button" class="fcs-nav-tab fcs-nav-tab--active" data-tab="tab-blackouts">
				<?php
				esc_html_e( 'Global Closures', 'fuelchef-subscriptions' );
				?>
			</button>
			<button type="button" class="fcs-nav-tab" data-tab="tab-cutoff">
				<?php
				esc_html_e( 'Order Cutoff', 'fuelchef-subscriptions' );
				?>
			</button>
		...
		<form id="settingsForm" onsubmit="return false;">
			<section class="fcs-tab-panel fcs-tab-panel--active" id="tab-blackouts">
				<div class="fcs-card">
					<div class="fcs-card__header">
						...
						<?php
							esc_html_e( 'Global Store Closures', 'fuelchef-subscriptions' );
						?>
						</h2>
					</div>
					<div class="fcs-card__body">
						...
						<div class="fcs-calendar-toolbar">
							<button type="button" class="fcs-btn fcs-btn--icon" id="calPrevMonth" aria-label="
							<?php
							esc_attr_e( 'Previous month', 'fuelchef-subscriptions' );
							?>
							" title="
							<?php
							esc_attr_e( 'Previous month', 'fuelchef-subscriptions' );
							...
							">
								<svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
									<path d="M11 4.5 6.5 9l4.5 4.5" stroke="currentColor" stroke-width="1.75"
											stroke-linecap="round" stroke-linejoin="round"/>
								</svg>
							</button>
							<strong class="fcs-calendar-toolbar__title" id="globalCalendarMonth"></strong>
							<button type="button" class="fcs-btn fcs-btn--icon" id="calNextMonth" aria-label="
							<?php
							esc_attr_e( 'Next month', 'fuelchef-subscriptions' );
							?>
							" title="
							<?php
							esc_attr_e( 'Next month', 'fuelchef-subscriptions' );
							...
							">
								<svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
									<path d="M7 4.5 11.5 9 7 13.5" stroke="currentColor" stroke-width="1.75"
											stroke-linecap="round" stroke-linejoin="round"/>
								</svg>
							</button>
						</div>
						...
						<div class="fcs-calendar-legend">
							...
							<?php
							esc_html_e( 'Closed store-wide', 'fuelchef-subscriptions' );
							?>
							<span>
							<?php
								esc_html_e(
			...
			<section class="fcs-tab-panel" id="tab-cutoff">
				<div class="fcs-card">
					<div class="fcs-card__header">
						<h2 class="fcs-card__title">
						<?php
							esc_html_e( 'Order Cutoff Time', 'fuelchef-subscriptions' );
						?>
						</h2>
					</div>
					<div class="fcs-card__body">
						...
						<div class="fcs-inline-field">
							...
							<?php
								esc_html_e( 'Lock orders', 'fuelchef-subscriptions' );
							?>
							</label>
							<input
								...
								value="
								<?php
								echo esc_attr( (string) $settings->cutoff_days() );
								?>
								"
							>
							<span>
							<?php
								esc_html_e( 'day(s) before fulfilment, at', 'fuelchef-subscriptions' );
							?>
							</span>
							<input
								class="fcs-input"
								...
								value="
								<?php
								echo esc_attr( substr( $settings->cutoff_time(), 0, 5 ) );
								?>
								"
							>
						</div>
						...
						<div class="fcs-notice">
							<strong>
							<?php
								esc_html_e( 'Example:', 'fuelchef-subscriptions' );
							?>
							</strong>
							<?php
							esc_html_e(
			...
			<section class="fcs-tab-panel" id="tab-checkout-fields">
				<div class="fcs-card">
					<div class="fcs-card__header">
						<h2 class="fcs-card__title">
						<?php
							esc_html_e( 'Fulfilment Date Field', 'fuelchef-subscriptions' );
						?>
						</h2>
					</div>
					<div class="fcs-card__body">
						...
						<div class="fcs-field">
							...
							<?php
								esc_html_e( 'Field label', 'fuelchef-subscriptions' );
							?>
							</label>
							<input
								class="fcs-input"
								...
								value="
								<?php
								echo esc_attr( $settings->fulfilment_date_label() );
								?>
								"
							>
						</div>
						...
						<div class="fcs-field">
							...
							<?php
								esc_html_e( 'Help text (optional)', 'fuelchef-subscriptions' );
							?>
							</label>
							<textarea
								class="fcs-textarea"
							...
							>
							<?php
								echo esc_textarea( $settings->fulfilment_date_description() );
							?>
							</textarea>
						...
						<div class="fcs-field">
							...
							<?php
								esc_html_e( 'Maximum fulfilment window', 'fuelchef-subscriptions' );
							?>
							</label>
							<div class="fcs-inline-value">
								<input
									...
									value="
									<?php
									echo esc_attr( (string) $settings->max_fulfilment_window_days() );
									?>
									"
								>
								<span>
								<?php
									esc_html_e( 'days into the future', 'fuelchef-subscriptions' );
								?>
								</span>
							</div>
							<p class="fcs-field__hint">
				...
				<div class="fcs-card">
					...
					<div class="fcs-card__body">
						...
						<div class="fcs-field">
							...
							<?php
								esc_html_e( 'Discount', 'fuelchef-subscriptions' );
							?>
							</label>
							<div class="fcs-percent-input">
								<input
									...
									value="
									<?php
									echo esc_attr( (string) $settings->subscribe_discount_percent() );
									?>
									"
								>
						...
						<div class="fcs-field">
							...
							<?php
								esc_html_e( 'Applies to', 'fuelchef-subscriptions' );
							?>
							</label>
							<select class="fcs-select" id="subscribeApplicability">
								<?php
								foreach ( $data['applicabilities'] as $value ) :
									?>
									<option value="
									<?php
									echo esc_attr( $value );
									...
									" 
									<?php
									selected( $settings->subscribe_applicability(), $value );
									?>
									>
										<?php
										echo esc_html( Subscribe_Applicability::label( $value ) );
										?>
									</option>
									<?php
								endforeach;
				...
				<div class="fcs-card">
					<div class="fcs-card__header">
						<h2 class="fcs-card__title">
						<?php
							esc_html_e( 'Checkout Wording', 'fuelchef-subscriptions' );
						?>
						</h2>
					</div>
					<div class="fcs-card__body">
						...
						<div class="fcs-field">
							...
							<?php
								esc_html_e( 'Checkbox label', 'fuelchef-subscriptions' );
							?>
							</label>
							<input
								class="fcs-input"
								...
								value="
								<?php
								echo esc_attr( $settings->subscribe_save_label() );
								?>
								"
							>
							<p class="fcs-field__hint">
						...
						<div class="fcs-field">
							...
							>
							<?php
								echo esc_textarea( $settings->subscribe_save_description() );
							?>
							</textarea>
							<p class="fcs-field__hint">
							<?php
			...
			<div class="fcs-submit-bar">
				<button type="button" class="fcs-btn fcs-btn--primary" id="saveSettingsBtn">
					<?php
					esc_html_e( 'Save Changes', 'fuelchef-subscriptions' );
					?>
				</button>
				<span class="fcs-save-status fcs-save-status--saved" id="fcsSaveStatus">
				&#10003; 
				<?php
					esc_html_e( 'All changes saved', 'fuelchef-subscriptions' );
				?>
			</span>
			</div>
		</form>
